  ...
  return (
    <Card
      className={` bg-gray-700 border-gray-600 transition-colors hover:bg-gray-600 ${
        currentFocus && currentFocus.id === room.id ? "bg-gray-600" : ""
      }`}
    >
          ...
          <div className="flex items-center space-x-2">
            <Tooltip>
              <TooltipTrigger asChild>
                <div
                  className="mr-2 hover:bg-slate-500 p-1 rounded-full"
                  onClick={onLinkClick}
                >
                  <Link
              ...
              <TooltipContent className="bg-white px-2 py-1 rounded text-sm mb-2">
                Book this room
              </TooltipContent>
            </Tooltip>
